...
import com.example.mynotes.featurenote.presentation.notes.NotesEvent
import com.example.mynotes.featurenote.presentation.notes.NotesViewModel
        ...
        LazyColumn(
            ...
            item {
                Row(
                    ...
                    Text(text = stringResource(id = R.string.notes_screen_title))
                    IconButton(onClick = {
